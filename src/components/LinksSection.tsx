...
// Social links configuration - these can be easily customized
...
const LinksSection = () => {
  return (
    <section id="links-section" className="relative z-10 py-16 px-4">
      <div className="flex flex-col items-center gap-4 max-w-md mx-auto">
        {/* Services Header */}
        <div className="text-center mb-4">
          <p className="font-rajdhani text-3xl text-white tracking-wide mb-1">
            Conheça os
          </p>
          <p className="font-montserrat text-3xl font-extrabold gradient-text tracking-wide">
            MEUS SERVIÇOS:
          </p>
        </div>
        ...
        {/* Service Buttons */}
        <SocialButton
          icon={landingPageLink.icon}
          label={landingPageLink.label}
