...
const SocialButton = ({ icon, label, href, description }: SocialButtonProps) => {
  return (
    <a
      ...
      className="group relative flex items-center gap-4 w-full max-w-[300px] md:max-w-sm mx-auto overflow-hidden rounded-xl transition-all duration-300 hover:scale-[1.02]"
    >
      ...
      <div className="relative z-10 flex items-center gap-3 md:gap-4 w-full px-4 py-3 md:px-6 md:py-4">
        ...
        <div className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-lg bg-gradient-to-br from-primary/30 to-secondary/30 border border-primary/50 group-hover:from-primary/50 group-hover:to-secondary/50 transition-all duration-300 flex-shrink-0">
          <div className="text-foreground group-hover:scale-110 transition-transform duration-300 scale-90 md:scale-100">
            {icon}
          </div>
        </div>
